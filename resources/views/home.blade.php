...
<main>
    <div class="text">
        ...
        <ol>
            ...
            <li><b>Adicione suas tarefas</b>: No painel, clique em “Criar” e insira o título, descrição, data de vencimento e a prioridade. Assim, fica mais fácil saber o que precisa ser feito primeiro!</li>
            <li><b>Acompanhe seu progresso</b>: Na lista de tarefas, visualize tudo que está pendente e marque as concluídas. Você pode filtrar por prioridade ou por data para não perder nada de vista.</li>
            <li><b>Mantenha o foco</b>: Com o <span class="detail-tarefoco">Tarefoco</span>, sua organização está a um clique de distância!</li>
        </ol>
